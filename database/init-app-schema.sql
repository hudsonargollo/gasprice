...
-- This script initializes the application schema in the shared PostgreSQL database

-- Connect to the fuelprice_pro database (should already exist)
\c fuelprice_pro;
...
BEGIN
    ...
    -- Only insert sample data if admin user exists and no stations exist yet
...
-- Grant necessary permissions to the fuelprice_admin user
