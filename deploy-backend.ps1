# Quick Backend Deployment for Factory Provisioning

Write-Host "🚀 Deploying Factory Provisioning to VPS..." -ForegroundColor Green

$deployScript = @'
#!/bin/bash
set -e
echo "=== DEPLOYING FACTORY PROVISIONING ==="
...
# Execute deployment
ssh root@vmi3098793.contaboserver.net "cd /opt/applications/fuelprice-pro && echo '$deployScript' > quick-deploy.sh && chmod +x quick-deploy.sh && ./quick-deploy.sh"
